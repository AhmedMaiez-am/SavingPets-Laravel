...
<h1 class="mt-0 mb-4" >Association Edit</h1>
</div>
...
<div class="container">
      ...
      <form action="{{ url('associations/' .$associations->id) }}" method="post">
        ...
        <input type="text" name="titre" id="titre" value="{{$associations->titre}}" class="form-control"></br>
        <label>adresse</label></br>
        <input type="text" name="adresse" id="adresse" value="{{$associations->adresse}}" class="form-control"></br>
        <label>email</label></br>
        <input type="text" name="email" id="email" value="{{$associations->email}}" class="form-control"></br>
        <label>telephone</label></br>
        <input type="text" name="telephone" id="telephone" value="{{$associations->telephone}}" class="form-control"></br>
