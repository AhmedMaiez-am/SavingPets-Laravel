                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="card-body">
                                    <h4 class="card-title">Nom d'évenement : {{ $events->nameEvent }}</h4>
                                    <h4 class="card-text">Description : {{ $events->description }}</h4>
                        ...
                        <a href="{{ url('/events/' . $events->id . '/edit') }}" title="Edit events"><button
                                class="btn btn-green"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                Edit</button></a>
                        <form method="POST" action="{{ url('/events' . '/' . $events->id) }}" accept-charset="UTF-8"
                            style="display:inline">
                            {{ method_field('DELETE') }}
                            {{ csrf_field() }}
                            <button type="submit" class="btn btn-green" title="Delete events"
