...
<div class="container">
    <form action="{{ url('events/' .$events->id) }}" method="post">
        ...
        <label>Nom d'évenement</label></br>
        <input type="text" name="nameEvent" id="nameEvent" value="{{$events->nameEvent}}" class="form-control"></br>
        <label>Description</label></br>
        <input type="text" name="description" id="description" value="{{$events->description}}"
