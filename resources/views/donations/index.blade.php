    ...
    <div class="row">
        <div class="col-md-9">
            <div class="card">
                ...
                <div class="card-body">
                    <a href="{{ url('/donations/create') }}" class="btn btn-success btn-sm" title="Add New donations">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $item->event_id }}</td>
                                    <td>
                                        <a href="{{ url('/donations/' . $item->id ) }}" title="View donations"><button
                                                class="btn btn-info btn-sm"><i class=" fa fa-eye"
                                                    aria-hidden="true"></i>
                                                View</button></a>
                                        <a href="{{ url('/donations/' . $item->id . '/edit') }}"
                                            title="Edit donations"><button class="btn btn-primary btn-sm"><i
                                                    class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                                Edit</button></a>
                                        <form method="POST" action="{{ url('/donations' . '/' . $item->id) }}"
                                            accept-charset="UTF-8" style="display:inline">
                                            {{ method_field('DELETE') }}
                                            {{ csrf_field() }}
                                            <button type="submit" class="btn btn-primary btn-sm" title="Delete Donation"
