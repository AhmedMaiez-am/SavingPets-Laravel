        ...
        <div class="container">
            ...
            @foreach($actions as $item)
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 teammate animated hiding" data-animation="fadeInLeft" data-delay="600">
                    ...
                    <div class="profile-photo"><img class="img-fluid" src="img/team/401.jpg" alt="">
                    </div>
    ...
    <div class="row">
        <div class="col-md-9">
            <div class="card">
                ...
                <div class="card-body">
                        <a href="{{ url('/actions/create') }}" class="btn btn-primary btn-sm" title="Add New action">
                            ...
                            <table class="table">
                                ...
                                @foreach($actions as $item)
                                    <tr>
                                        ...
                                        <td>
                                        <a href="" title="View Action" data-toggle="modal"
                                            data-target="#myModal"><button class="btn btn-info btn-sm"><i
                                                    class=" fa fa-eye" aria-hidden="true"></i>
                                                View</button></a>
                                        <a href="{{ url('/actions/' . $item->id . '/edit') }}"
                                            title="Edit action"><button class="btn btn-primary btn-sm"><i
                                                    class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                                Edit</button></a>
                                        <form method="POST" action="{{ url('/actions' . '/' . $item->id) }}"
                                            accept-charset="UTF-8" style="display:inline">
                                            {{ method_field('DELETE') }}
                                            {{ csrf_field() }}
                                            <button type="submit" class="btn btn-primary btn-sm" title="Delete Action"
